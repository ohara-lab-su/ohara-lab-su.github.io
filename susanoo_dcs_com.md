...
TANGO のデバイスサーバモデルもじつはMADOCAのような複雑な多段の
rouging ができないので、本質的・モデル的には一つのクライアントに対しての
複数のデバイスサーバの REQ/REP モデルと言ってもいい。
ただ、これを分散通信か？といえば、人によってはおそらく物言いが多くつくとは思う。
