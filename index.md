...
制御クラス側の python の API がそのままクライアント上での API となる。つまり APIを揃える場合は
制御クラス側で揃える。徹底的にミニマム志向で作られいる。
...
- [スサノオインストール: コボッタ制御サーバ (ese774)](https://ohara-lab-su.github.io/cobotta2/tutorials/install_server.html)
- [スサノオインストール: コボッタ制御クライアント (ese774)](https://ohara-lab-su.github.io/cobotta2/tutorials/install_client.html)
- [スサノオインストール: 電子天秤サーバ (gRPC)](https://ohara-lab-su.github.io/aandd_reader/tutorials/intro.html#a-ese774)
- [スサノオインストール: 電子天秤クライアント (gRPC)](https://ohara-lab-su.github.io/aandd_reader/tutorials/intro.html#a-ese774)

使用者はロボットのプログラムも通信のプログラムも複雑なプログラムを書くことも理解することもなく、
**簡単なシーケンススクリプト**だけで操作が可能である

- [ロボットと電子天秤の二つのでデバイスの操作](susanooo_robo.md)
...
スサノオプロジェクトにより多くの実験データーが蓄えられたあとは、データを解析する必要がある。
