...
[!Note]
2015.11頃に初心者向けの第一元計算入門をCMSIから依頼されて執筆した文章です。最終的にはCMSIには投稿しておりません。実は、最終版の登校前に都合、身分の都合ドタキャンせざるを得なかった曰く付きの文章でもあります。原稿を見ていただいた先生を初め、当時の関係各者にご迷惑をおかけしました。せっかくなので書庫から引っ張りして、MD化した ので公開致します。
